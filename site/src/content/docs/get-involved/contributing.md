---
title: Contributing
description: Thanks for taking the time to look at mdd!
sidebar:
  order: 1
editUrl: https://github.com/schubergphilis/mdd/edit/main/CONTRIBUTING.md
---

Thanks for taking the time to look at `mdd`!

Contributions are governed by the [Apache-2.0 licence](/mdd/get-involved/license/), and
participation by the [Code of Conduct](/mdd/get-involved/code-of-conduct/).
