...
| S14 | [confluence sync command](S14-confluence-sync.md) | `mdd confluence sync` is the primary bidirectional verb for keeping a GitLab mirror repo in lockstep with its Confluence space. | Implemented (2026-05-08) |
