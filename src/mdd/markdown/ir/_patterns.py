...
# cannot hold verbatim (line breaks, ``}``, control characters) and for any
# value that itself starts with the prefix, so the prefix is never ambiguous.
FENCE_ATTR_B64_PREFIX = "confluence-b64:"
