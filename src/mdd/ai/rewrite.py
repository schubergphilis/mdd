"""AI-powered markdown rewrite with protected-region pipeline (spec S21).
...
_PROTECTED_PATTERNS: list[tuple[str, re.Pattern[str]]] = [
    ...
    # (spec S09: "> **Confluence export …" up to the next blank line or heading)
    (
        "export_header",
        re.compile(
    ...
    # (spec S09: "> *Generated by mdd …" at the end of the file)
    (
        "mdd_footer",
        re.compile(
...
def _check_managed_for_apply(path: Path, full_text: str) -> bool:  # noqa: ARG001
    ...
    Checks ``confluence.managed_by`` in the frontmatter (stamped by spec S26
...
def rewrite_file(  # noqa: C901, PLR0911, PLR0912, PLR0915
    ...
    *,
    ...
    # When --apply is set, check for managed-elsewhere before overwriting (spec S26).
    if apply:
        try:
...
def rewrite_files(
    ...
    *,
    ...
    """Rewrite multiple files serially (spec S21: no parallelism).
